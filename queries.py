...
pprint.pprint(
    project(
        theta_join(
            rename(
                Employee, ['EmployeeId','Lname', 'Fname', 'Title', 'ReportsTo','BirthDate','HireDate','eAddress', 'eCity','eState','eCountry','ePostalCode',
                'ePhone','eFax','eEmail']
            ),
			natural_join(
            	Customer,
                    ...
                    natural_join(
                        ...
                        natural_join(
                            ...
                            theta_join(
                                ...
                                lambda t1, t2: t1.MediaTypeId == t2.MediaId 
                            )
                        )
                    )
                )
...
pprint.pprint(
    project(
        theta_join(
            ...
            ), lambda t1, t2: t1.MediaId == t2.MediaTypeId
        ),
        ['Fname', 'Lname']
    )
)